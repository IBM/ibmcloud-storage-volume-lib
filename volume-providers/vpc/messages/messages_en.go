...
var messagesEn = map[string]Message{
	...
	"InvalidVolumeID": Message{
		...
		Description: "'%s' volume ID is not valid.[Backend Error: Not a valid volume ID, Please check: https://cloud.ibm.com/docs/infrastructure/vpc?topic=vpc-rias-error-messages#volume_id_invalid]",
		Type:        "InvalidRequest",
		RC:          400,
		Action:      "Volume ID is not valid. Please review [Backend] error which is returned.",
	},
	"InvalidVolumeName": Message{
		Code:        "InvalidVolumeName",
		Description: "'%s' volume name is not valid.[Backend Error: Not a valid volume ID, Please check: https://cloud.ibm.com/docs/infrastructure/vpc?topic=vpc-rias-error-messages#validation_invalid_name]",
		Type:        "InvalidRequest",
		RC:          400,
		Action:      "Volume name is not valid. Please check [Backend] error.",
	},
	"VolumeCapacityInvalid": Message{
		Code:        "VolumeCapacityInvalid",
		Description: "'%d' volume capacity is not valid.[Backend Error:https://cloud.ibm.com/docs/infrastructure/vpc?topic=vpc-rias-error-messages#volume_capacity_zero_or_negative]",
		Type:        "InvalidRequest",
		RC:          400,
		Action:      "Volume capacity is not valid. Please check [Backend] error.",
	},
	"IopsInvalid": Message{
		Code:        "IopsInvalid",
		Description: "'%s' volume IOPs  is not valid.[Backend Error: https://cloud.ibm.com/docs/infrastructure/vpc?topic=vpc-rias-error-messages#volume_iops_zero_or_negative]",
		Type:        "InvalidRequest",
		RC:          400,
		Action:      "Volume IOPs is not valid.",
	},
	"VolumeProfileIopsInvalid": Message{
		Code:        "VolumeProfileIopsInvalid",
		Description: "IOPS value not allowed by profile. [Backend Error: https://cloud.ibm.com/docs/infrastructure/vpc?topic=vpc-rias-error-messages#volume_profile_iops_invalid]",
		Type:        "InvalidRequest",
		RC:          400,
		Action:      "IOPS value not allowed by profile. Please check [Backend] error",
	},
