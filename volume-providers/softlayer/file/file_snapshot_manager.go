...
func (sls *SLFileSession) SnapshotCreate(volume *provider.Volume, tags map[string]string) (*provider.Snapshot, error) {
...
// Delete the snapshot
func (sls *SLFileSession) SnapshotDelete(del *provider.Snapshot) error {
...
// Get the snapshot
func (sls *SLFileSession) SnapshotGet(snapshotId string) (*provider.Snapshot, error) {
	// Step 1- Validate inputes
	...
	//! TODO: need to convert to local type
	return nil, nil
}
...
func (sls *SLFileSession) ListAllSnapshots(volumeID string) ([]*provider.Snapshot, error) {
